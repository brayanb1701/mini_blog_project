				...
				<div class="container">
					<div class="row">
						...
						<div class="col-xs-10 text-right menu-1">
							<ul>
								<li class="active"><a href="index.php">Publicaciones</a></li>
			...
			<div class="container">
				<div class="row">
					...
					<?php
						...
						$sql="SELECT titulo,autor,fecha,categoria,texto,n_imagen FROM proyecto.posts WHERE activo='S'";
						...
						<article class="blog-entry">
							<div class="blog-wrap">
								...
								<div class="blog-image">
									<a  class="blog-img text-center" style="background-image: url(images/<?php echo $n_imagen; ?> );"></a>
									<ul class="share">
								...
								?>
								<span class="category text-center"><i class="icon-calendar3"></i> <?php echo $fecha; ?> | <a class="posted-by"><i class="icon-user2"></i> by <?php echo $autor; ?> </a> </span>
							</div>
							<div class="desc">
								<p class="first-letra"><?php echo $texto; ?> </p>
							</div>
